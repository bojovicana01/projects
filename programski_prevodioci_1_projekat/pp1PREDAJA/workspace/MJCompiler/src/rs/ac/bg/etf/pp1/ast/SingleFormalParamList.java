...
public class SingleFormalParamList extends FormalParamList {

    private FormalParamDecl FormalParamDecl;

    public SingleFormalParamList (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleFormalParamList(\n");
