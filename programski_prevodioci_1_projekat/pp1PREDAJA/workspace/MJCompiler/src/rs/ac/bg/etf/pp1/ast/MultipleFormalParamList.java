...
public class MultipleFormalParamList extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public MultipleFormalParamList (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleFormalParamList(\n");
